    ...
    <main className="min-h-screen bg-white selection:bg-yellow-400 selection:text-green-950">
      ...
      <section className="relative min-h-[70vh] flex items-center bg-green-950 text-white overflow-hidden pt-20">
        <div className="absolute inset-0 z-0">
          ...
          <Image 
            ...
            fill 
            className="object-contain opacity-[0.03] scale-150 rotate-12 translate-x-1/4"
          />
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
            ...
            <div className="w-full lg:w-1/2 relative">
              ...
              <div className="relative z-10 p-4 bg-white rounded-[3rem] md:rounded-[4rem] shadow-2xl border border-gray-100 transition-all duration-700">
                ...
                <div className="absolute -bottom-6 -right-4 md:-bottom-8 md:-right-8 bg-green-950 text-white p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] shadow-xl max-w-[220px] md:max-w-[280px]">
      ...
      <section className="px-6 pb-24 md:pb-40">
        <div className="max-w-6xl mx-auto">
          <div className="bg-green-950 rounded-[3rem] md:rounded-[4rem] p-12 md:p-24 text-center relative overflow-hidden shadow-2xl">
